...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Edit Property Taker') }}</div>
                    ...
                    <form method="POST" action="{{ route('property_takers.update', $propertyTaker->id) }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <textarea id="address" class="form-control" name="address" required>{{ old('address', $propertyTaker->address) }}</textarea>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.01" id="stamp_duty" class="form-control" name="stamp_duty" value="{{ old('stamp_duty', $propertyTaker->stamp_duty) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <label for="any_other_charges" class="col-form-label text-md-end">{{ __('Any Other Charges') }}</label>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary">{{ __('Update Property Taker') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
