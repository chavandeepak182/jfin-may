...
<div class="row">
    <div class="col-12 grid-margin">
        <div class="card pt-3">
            <form method="GET" action="{{ route('mis.index') }}" class="mt-4 mb-3">
            <div class="row justify-content-space-between">
                ...
                <div class="col-md-3 d-flex align-items-end">
                    ...
                    <a href="{{ route('mis.index') }}" class="btn btn-secondary ms-2">Reset</a>
                </div>
            </div>
        </form>
            <div class="card-body">
...
<script>
    $(document).ready(function() {
        ...
        if (!$.fn.DataTable.isDataTable('#misDataTable')) {
...
function reloadLoansTable() {
        ...
        var table = $('#misDataTable').DataTable();
