        ...
        <div class="container">
            <div class="user signinBx">
                ...
                <div class="formBx">
                    ...
                    <form action="{{ Route('submit-otp') }}" method="POST" class="row">
                        <h2>Verify Otp</h2>
                        @csrf

                        <input type="hidden" name="mobile_no" class="form-control"
                            placeholder="Enter your mobile number" value="{{ session('mobile_no') }}">
