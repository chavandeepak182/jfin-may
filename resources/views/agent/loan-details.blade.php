...
<div class="bg-white">
    @if ($loan)
        ...
        <div class="row">
            <!-- Left side -->
            <div class="col-lg-8 p-5 pt-3">
                <!-- Basic information -->
                <h3 class="h5 mb-3"><strong>Basic Information</strong></h3>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb-3">
                ...
                <!-- Profile Information -->
                @if ($profile)
                <h3 class="h5 mb-3 mt-3"><strong>Profile Information</strong></h3>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb-3">
            ...
            <div class="col-lg-4 p-3 bg-light">
                ...
                @if ($education)
                <div class="card-body">
                    <h3 class="h5 mb-3"><strong>Educational Information</strong></h3>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
