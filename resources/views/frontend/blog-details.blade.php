...
<section class="hero-wrap position-relative">
    ...
    <div class="blog-featured-image-overlay position-absolute w-100 h-100" 
         style="top:0; left:0; background-color: rgba(0,0,0,0.4);">
    </div>

    <div class="container hero-content position-absolute top-50 start-50 translate-middle text-white text-center">
        <h1 class="hero-title display-5 fw-bold">{{ $blog->blog_name }}</h1>
        <p class="hero-sub lead mt-2">
