        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <nav aria-label="breadcrumb" class="d-flex align-items-center">
                <ol class="breadcrumb m-0 bg-transparent">
                    <li class="breadcrumb-item"><a href="{{ route('loan.profile') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('loans.loans-list') }}">All Loans</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Edit Loan</li>
                </ol>
            </nav>
            <!-- Add User Button -->
            <div>
                <a href="{{ route('loans.loans-list') }}" class="btn btn-secondary"><i
                    ...
                    success: function(response) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                "{{ route('loans.loans-list') }}"; // Redirect to the loans index
                            }
                        });
                    },
