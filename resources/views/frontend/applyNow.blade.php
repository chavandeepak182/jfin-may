    ...
    <div class="container">
        <div class="row g-5 mt-3 mb-5 align-items-center">
            ...
            <div class="col-md-6 wow fadeInRight" data-wow-delay="0.4s">
                <a href="/start_loan/1" class="btn btn-light rounded-pill py-2 px-4 ms-3 flex-shrink-0">New Loan</a> 
                @if(Session::get('username'))
                    <a href="/start_loan/2" class="btn btn-light rounded-pill py-2 px-4 ms-3 flex-shrink-0">Exiting Loans</a> 
                @endif
            </div>
        </div>
    </div>
