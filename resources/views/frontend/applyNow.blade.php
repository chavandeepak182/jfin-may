        ...
        <div class="row text-center justify-content-center">
            <div class="col-md-6 mb-5 bg-white rounded">
                <div class="row align-items-center">
                    <div class="col-md-6 p-0 wow fadeInLeft" data-wow-delay="0.2s">
                    ...
                    <div class="col-md-6 wow fadeInRight" data-wow-delay="0.4s">
                        ...
                        @if(Session::get('username'))
                            <a href="/start_loan/2" class="btn btn-light rounded-0 py-2 px-4 ms-3 flex-shrink-0">Exiting Loans</a> 
                        @endif
                    </div>
                </div>
            </div>
