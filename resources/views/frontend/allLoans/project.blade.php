        ...
        <div class="container d-flex align-items-center justify-content-between py-5">
            <div class="row">
                <div class="col-md-6 py-5">
                    <h2 class="text-dark display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">We Provide Project Finance Solutions Worldwide</h2>
                    <p class="mt-4 text-dark"><strong>With a steadfast commitment to maximizing the profitability of every client transaction.</strong></p>
