        ...
        <div class="container d-flex align-items-center justify-content-between py-5">
            <div class="row">
                <div class="col-md-6 py-5">
                    <h2 class="text-dark display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Unlock the Value of Your Property with a Loan Against Property</h2>
                    <p class="mt-4 text-dark"><strong>In need of quick funds? Look no further than Loan Against Property, commonly referred to simply as Contracts.</strong></p>
