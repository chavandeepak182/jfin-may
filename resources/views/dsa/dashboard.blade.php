            ...
            <div class="table-container-large">
                <table class="loans-table">
                    ...
                    <tbody>
                            ...
                            <td>
                                <div class="customer-cell">
                                    ...
                                    <div class="customer-info">
                                        ...
                                        <div class="customer-id">#LN001</div>
                                    </div>
                                </div>
                            </td>
                            <td>Home Loan</td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="customer-cell">
                                    ...
                                    <div class="customer-info">
                                        <div class="customer-name">Amit Patil</div>
                                        <div class="customer-id">#LN002</div>
                                    </div>
                                </div>
                            </td>
                            <td>Personal Loan</td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="customer-cell">
                                    ...
                                    <div class="customer-info">
                                        <div class="customer-name">Sneha Kulkarni</div>
                                        <div class="customer-id">#LN003</div>
                                    </div>
                                </div>
                            </td>
                            <td>Car Loan</td>
                            <td>
                                <div class="credit-score-cell">
                                    <span class="credit-score-value">720</span>
                                    <span class="credit-score-label good">Good</span>
                                    <div class="credit-score-bar">
                                        <div class="credit-score-fill good" style="width:75%"></div>
                                    </div>
                                </div>
                            </td>
                            <td>₹8,00,000</td>
                        ...
                        <!--
                        <tr>
                            <td colspan="8" class="text-center">No loans available</td>
                        </tr>
                        -->
