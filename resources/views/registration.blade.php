                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="{{ url('services') }}" class="nav-link nav-link {{ Request::is('services*') || Request::is('home-loan') || Request::is('loan-against-property') || Request::is('project-loan') || Request::is('overdraft-facility') || Request::is('lease-rental-discounting') || Request::is('msme-loan') ? 'active' : '' }}">SERVICES</a>
                            ...
                            <a href="{{ url('applyNow') }}" class="btn btn-primary rounded-pill py-2 px-4 ms-3">Apply Now</a>
                        </div>
                    </div>
                </nav>
            </div>
