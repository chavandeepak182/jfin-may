                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="customer-cell">
                                            <div class="customer-avatar">
                                                {{ strtoupper(substr($loan->user_name,0,2)) }}
                                            </div>
                                            <div class="customer-info">
                                                <div class="customer-name">{{ $loan->user_name }}</div>
                                                <div class="customer-id">#{{ $loan->loan_reference_id }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="credit-score-cell">
                                            <span class="credit-score-value">{{ $loan->credit_score ?? 'N/A' }}</span>
    ...
    var loanStatusChart = new Chart(ctx1, {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: ['#D49B54', '#1E5128', '#1E3E62', '#C74B50'], 
                borderColor: '#ffffff',
                borderWidth: 
            }]
        },
