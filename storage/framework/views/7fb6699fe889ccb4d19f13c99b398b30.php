...
<div style="padding: 1%"> 
    ...
    <!-- Search Form -->
    <form method="GET" action="<?php echo e(route('admin.transactions')); ?>" class="mb-4">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <table class="table table-striped" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($transaction->user_name); ?></td>
            ...
            <div class="d-flex justify-content-center mt-3">
                <?php echo $data['transactions']->appends(['search' => request()->input('search')])->links('pagination::bootstrap-5'); ?>
...
<?php echo $__env->make('layouts.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u838013575/domains/jfinserv.com/public_html/resources/views/admin/transactions.blade.php ENDPATH**/ ?>