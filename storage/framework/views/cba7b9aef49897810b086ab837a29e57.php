<?php $__env->startSection('title', "Financial Services Companies in Pune - Jfinserv"); ?>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-xl-5 wow fadeInLeft mx-auto" data-wow-delay="0.2s">
                        <img src="<?php echo e(asset('theme')); ?>/frontend/img/target.jpg" class="w-100 rounded shadow" alt="">
                    </div>
                ...
                <div class="row g-4 justify-content-center">
                    <div class="col-md-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="feature-item p-3 pb-4 text-center">
                            <img src="<?php echo e(asset('theme')); ?>/frontend/img/bnk_logos/pnb.jpg" alt="" class="w-50 rounded mb-4">
                    ...
                    <div class="col-md-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="feature-item p-3 pb-4 text-center">
                            <img src="<?php echo e(asset('theme')); ?>/frontend/img/bnk_logos/arks.jpg" alt="" class="w-50 rounded mb-4">
                    ...
                    <div class="col-md-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="feature-item p-3 pb-2 text-center">
                            <img src="<?php echo e(asset('theme')); ?>/frontend/img/bnk_logos/bom.jpg" alt="" class="w-50 rounded mb-4">
                    ...
                    <div class="col-md-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="feature-item p-3 pb-4 text-center text-center">
                            <img src="<?php echo e(asset('theme')); ?>/frontend/img/bnk_logos/ar.jpg" alt="" class="w-50 rounded mb-4">
                    ...
                    <div class="col-md-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="feature-item p-3 pb-4 text-center">
                            <img src="<?php echo e(asset('theme')); ?>/frontend/img/bnk_logos/indian.png" alt="" class="w-50 rounded mb-4">
            ...
            <div class="container pb-5">
                ...
                <div class="row g-4 justify-content-center">
                    <div class="col-md-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="<?php echo e(asset('theme')); ?>/frontend/img/team/dilip-y.jpg" class="img-fluid rounded-top w-100" alt="">
                                <div class="team-icon">
                    ...
                    <div class="col-md-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="<?php echo e(asset('theme')); ?>/frontend/img/team/nadir.png" class="img-fluid rounded-top w-100" alt="">
                                <div class="team-icon">
                                    <a class="btn btn-primary btn-sm-square rounded-pill" href=""><i class="fab fa-linkedin-in"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="<?php echo e(asset('theme')); ?>/frontend/img/team/sunil.png" class="img-fluid rounded-top w-100" alt="">
                                <div class="team-icon">
                                    <a class="btn btn-primary btn-sm-square rounded-pill" href=""><i class="fab fa-linkedin-in"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="<?php echo e(asset('theme')); ?>/frontend/img/team/ajay.png" class="img-fluid rounded-top w-100" alt="">
                                <div class="team-icon">
                                    <a class="btn btn-primary btn-sm-square rounded-pill" href=""><i class="fab fa-linkedin-in"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="<?php echo e(asset('theme')); ?>/frontend/img/team/parag.png" class="img-fluid rounded-top w-100" alt="">
                                <div class="team-icon">
                                    <a class="btn btn-primary btn-sm-square rounded-pill" href=""><i class="fab fa-linkedin-in"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="<?php echo e(asset('theme')); ?>/frontend/img/team/praksh.png" class="img-fluid rounded-top w-100" alt="">
                                <div class="team-icon">
                                    <a class="btn btn-primary btn-sm-square rounded-pill" href=""><i class="fab fa-linkedin-in"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="<?php echo e(asset('theme')); ?>/frontend/img/team/viraj.png" class="img-fluid rounded-top w-100" alt="">
                                <div class="team-icon">
                                    <a class="btn btn-primary btn-sm-square rounded-pill" href=""><i class="fab fa-linkedin-in"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="<?php echo e(asset('theme')); ?>/frontend/img/team/lokesh.png" class="img-fluid rounded-top w-100" alt="">
                                <div class="team-icon">
                                    <a class="btn btn-primary btn-sm-square rounded-pill" href=""><i class="fab fa-linkedin-in"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="<?php echo e(asset('theme')); ?>/frontend/img/team/nidhi.png" class="img-fluid rounded-top w-100" alt="">
                                <div class="team-icon">
                                    <a class="btn btn-primary btn-sm-square rounded-pill" href=""><i class="fab fa-linkedin-in"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="<?php echo e(asset('theme')); ?>/frontend/img/team/rushi.png" class="img-fluid rounded-top w-100" alt="">
                                <div class="team-icon">
                                    <a class="btn btn-primary btn-sm-square rounded-pill" href=""><i class="fab fa-linkedin-in"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="<?php echo e(asset('theme')); ?>/frontend/img/team/dumy.jpg" class="img-fluid rounded-top w-100" alt="">
                                <div class="team-icon">
                                    <a class="btn btn-primary btn-sm-square rounded-pill" href=""><i class="fab fa-linkedin-in"></i></a>
                                </div>
                            </div>
            ...
            <div class="container pb-5">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.4s">
                        <img src="<?php echo e(asset('theme')); ?>/frontend/img/faq-2.jpg" class="img-fluid w-100" alt="">
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('frontend.layouts.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u838013575/domains/jfinserv.com/public_html/resources/views/frontend/about.blade.php ENDPATH**/ ?>