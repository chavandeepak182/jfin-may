                            ...
                            <div class="col-lg-6 animated fadeInLeft">
                                <div class="text-sm-center text-md-start">
                                    ...
                                    <div class="d-flex justify-content-center justify-content-md-start flex-shrink-0 mb-4">
                                        ...
                                        <a class="btn-search btn btn-danger rounded-1 py-3 px-4 px-md-5 ms-2" href="<?php echo e(url('/applyNow')); ?>">APPLY NOW</a>
                                    </div>
                                </div>
                            </div>
                            <!-- <div class="col-lg-6 animated fadeInRight">
                                <div class="calrousel-img" style="object-fit: cover;">
                                    <img src="<?php echo e(asset('theme')); ?>/frontend/img/referral.png" class="img-fluid" alt="Fast Loan Process">
                                </div>
                            </div> -->
                        </div>
                    </div>
                ...
                <div class="carousel-caption">
                    <div class="container">
                        <div class="row g-4 align-items-center">
                            ...
                            <!-- <div class="col-lg-6 animated fadeInRight">
                                <div class="calrousel-img" style="object-fit: cover;">
                                    <img src="<?php echo e(asset('theme')); ?>/frontend/img/fast-process.png" class="img-fluid" alt="Fast Loan Process">
                                </div>
                            </div> -->
                        </div>
                    </div>
                        ...
                        <div class="row gy-4 gy-lg-0 gx-0 gx-lg-5 align-items-center">
                            <div class="col-lg-6 animated fadeInLeft">
                                <div class="calrousel-img">
                                    <img src="<?php echo e(asset('theme')); ?>/frontend/img/fast-process.png" class="img-fluid" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6 animated fadeInRight">
                                <div class="text-sm-center text-md-end">
                                    ...
                                    <div class="d-flex justify-content-center justify-content-md-end flex-shrink-0 mb-4">
                                        ...
                                        <a class="btn-search btn btn-light rounded-pill py-3 px-4 px-md-5 ms-2" href="<?php echo e(url('/applyNow')); ?>"><i class="far fa-hand-point-right me-2" style="font-size: 20px"></i> Apply Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-4 justify-content-center">
                                <div class="col-12">
                                    <div class="rounded bg-light">
                                        <img src="<?php echo e(asset('theme')); ?>/frontend/img/about-1.jpg" class="img-fluid rounded w-100" alt="">
                                    </div>
                                </div>
                                <div class="col-sm-6">
            ...
            <div class="container py-5">
                ...
                <div class="row g-4 justify-content-center">
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="service-item">
                            <div class="service-img">
                                <img src="<?php echo e(asset('theme')); ?>/frontend/img/Home_Loan.jpg" class="img-fluid rounded-top w-100" alt="">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="service-item">
                            <div class="service-img">
                                <img src="<?php echo e(asset('theme')); ?>/frontend/img/Project_Loan.jpg" class="img-fluid rounded-top w-100" alt="">
                                <!-- <div class="service-icon p-3">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="service-item">
                            <div class="service-img">
                                <img src="<?php echo e(asset('theme')); ?>/frontend/img/MSME_Loan.jpg" class="img-fluid rounded-top w-100" alt="">
                                <!-- <div class="service-icon p-3">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.8s">
                        <div class="service-item">
                            <div class="service-img">
                                <img src="<?php echo e(asset('theme')); ?>/frontend/img/Loan_Against_Property.jpg" class="img-fluid rounded-top w-100" alt="">
                                <!-- <div class="service-icon p-3">
            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.4s">
                        <img src="<?php echo e(asset('theme')); ?>/frontend/img/faq.jpg" class="img-fluid w-100" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid testimonial py-5">
            ...
            <div class="slider pb-5 mb-5">
                <div class="slide-track">
                    <div class="slide">
                        <img src="<?php echo e(asset('theme')); ?>/frontend/img/bnk_logos/ab.jpg" alt="">
                    </div>
                    <div class="slide">
                        <img src="<?php echo e(asset('theme')); ?>/frontend/img/bnk_logos/ar.jpg" alt="">
                    </div>
                    <div class="slide">
                        <img src="<?php echo e(asset('theme')); ?>/frontend/img/bnk_logos/arks.jpg" alt="">
                    </div>
                    <div class="slide">
                        <img src="<?php echo e(asset('theme')); ?>/frontend/img/bnk_logos/bom.jpg" alt="">
                    </div>
                    <div class="slide">
                        <img src="<?php echo e(asset('theme')); ?>/frontend/img/bnk_logos/cbi.jpg" alt="">
                    </div>
                    <div class="slide">
                        <img src="<?php echo e(asset('theme')); ?>/frontend/img/bnk_logos/chola.jpg" alt="">
                    </div>
                    <div class="slide">
                        <img src="<?php echo e(asset('theme')); ?>/frontend/img/bnk_logos/hdb.jpg" alt="">
                    </div>
                    <div class="slide">
                        <img src="<?php echo e(asset('theme')); ?>/frontend/img/bnk_logos/ib.jpg" alt="">
                    </div>
                    <div class="slide">
                        <img src="<?php echo e(asset('theme')); ?>/frontend/img/bnk_logos/indian.png" alt="">
                    </div>
                    <div class="slide">
                        <img src="<?php echo e(asset('theme')); ?>/frontend/img/bnk_logos/kotak.jpg" alt="">
                    </div>
                    <div class="slide">
                        <img src="<?php echo e(asset('theme')); ?>/frontend/img/bnk_logos/pnb.jpg" alt="">
                    </div>
                    <div class="slide">
                        <img src="<?php echo e(asset('theme')); ?>/frontend/img/bnk_logos/rbl.jpg" alt="">
                    </div>
                    <div class="slide">
                        <img src="<?php echo e(asset('theme')); ?>/frontend/img/bnk_logos/sc.jpg" alt="">
                    </div>
                    <div class="slide">
                        <img src="<?php echo e(asset('theme')); ?>/frontend/img/bnk_logos/ujjivan.jpg" alt="">
                    </div>
                    <div class="slide">
                        <img src="<?php echo e(asset('theme')); ?>/frontend/img/bnk_logos/union.jpg" alt="">
                    </div>
                    <div class="slide">
                        <img src="<?php echo e(asset('theme')); ?>/frontend/img/bnk_logos/yb.jpg" alt="">
                    </div>
                    <div class="slide">
                        <img src="<?php echo e(asset('theme')); ?>/frontend/img/bnk_logos/boi.png" alt="">
                    </div>
                    <div class="slide">
                        <img src="<?php echo e(asset('theme')); ?>/frontend/img/bnk_logos/uco.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('frontend.layouts.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u838013575/domains/jfinserv.com/public_html/resources/views/frontend/index.blade.php ENDPATH**/ ?>