...
<!-- kdkkd -->
    <form id="eligibilityForm" action="<?php echo e(route('calculateEligibilitystandalone')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <!-- Salary input (Fixed) -->
        <div class="form-group">
            ...
            <input type="number" name="salary" id="salary" class="form-control" placeholder="Enter your salary" 
                value="<?php echo e($data['userDetails']->netsalary ?? ''); ?>" required oninput="calculateTotalIncome()">
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" name="tax_amount" id="tax_amount" class="form-control" placeholder="Enter Tax Amount" required value="<?php echo e($taxAmount ?? ''); ?>" oninput="calculateMonthlyTax()">
                </div>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="number" name="coapplicant_salary" id="coapplicant_salary" class="form-control" 
                    ...
                    value="<?php echo e(old('coapplicant_salary', $eligibilityCriteria->income_from_business_amount ?? '')); ?>" 
    ...
    <div class="form-group col-md-6">
        ...
        <input type="text" id="coapplicant_monthly_avg" class="form-control" 
               ...
               value="<?php echo e(old('coapplicant_monthly_avg', number_format(($eligibilityCriteria->income_from_business_amount ?? 0) / 12, 2))); ?>" 
               readonly>
        </div>
    </div>
...
<div class="form-group">
    ...
    <div id="coApplicantAgricultureIncomeContainer">
        ...
        <?php if(!empty($coApplicantAgricultureIncomeData)): ?>
            <?php $__currentLoopData = $coApplicantAgricultureIncomeData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $income): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="row agriculture-income-row">
                    <div class="col-md-5 mt-2">
                        <input type="text" name="co_agriculture_income_json[]" class="form-control" placeholder="Enter agriculture income name" value="<?php echo e($income['source'] ?? ''); ?>">
                    </div>
                    <div class="col-md-3 mt-2">
                        <input type="number" name="co_agriculture_income_amount[]" class="form-control agriculture-income" placeholder="Enter agriculture income amount (Yearly)" value="<?php echo e($income['amount'] ?? ''); ?>" oninput="calculateTotalIncome()">
                    </div>
                    <div class="col-md-3 mt-2">
                        <input type="text" class="form-control avg-agriculture-income" placeholder="Avg Monthly Income" readonly>
                    </div>
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="number" name="coapplicant_tax_amount" id="coapplicant_tax_amount" class="form-control" placeholder="Enter Co-applicant Tax Amount"  value="<?php echo e($coapplicantTaxAmount ?? ''); ?>" oninput="calculateCoapplicantMonthlyTax()">
        </div>
    </div>
    ...
    <div id="coApplicantDeductionContainer">
        ...
        <div class="form-group">
            ...
            <select name="bank_id" id="bank_id" class="form-control" required>
                ...
                <?php $__currentLoopData = $data['foirBanks']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($bank->id); ?>"><?php echo e($bank->bank_name); ?> (FOIR: <?php echo e($bank->foir_percentage); ?>%)</option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jfinserv\resources\views/admin/calculator/standalone_self.blade.php ENDPATH**/ ?>