    ...
    <div class="container">
        ...
        <div class="row g-2 pb-4" data-wow-delay="0.2s">
            <div class="col-lg-2 col-md-6 col-sm-12 border me-3">
                <div class="p-3">
                    <img src="<?php echo e(asset('theme')); ?>/frontend/img/interest-rate.png" class="w-25 pb-3">
                    <p class="m-0 text-dark">Competitive Interest Rates</p>
                </div>
            </div>
            <div class="col-lg-2 col-md-6 col-sm-12 border me-3">
                <div class="p-3">
                    <img src="<?php echo e(asset('theme')); ?>/frontend/img/process.png" class="w-25 pb-3">
                    <p class="m-0 text-dark">Streamlined Documentation</p>
                </div>
            </div>
            <div class="col-lg-2 col-md-6 col-sm-12 border me-3">
                <div class="p-3">
                    <img src="<?php echo e(asset('theme')); ?>/frontend/img/computer.png" class="w-25 pb-3">
        ...
        <div class="wow fadeInUp py-5 text-dark" data-wow-delay="0.2s">
            <div class="row py-3 align-items-center">
                <div class="col-md-4 text-center">
                    <img src="<?php echo e(asset('theme')); ?>/frontend/img/criteria.jpg" alt="" class="w-100 shadow rounded">
                </div>
                <div class="col-md-8">
    ...
    <!-- Documentation for Project Loan -->
        <div class="wow fadeInUp py-3 text-dark" data-wow-delay="0.2s">
            <div class="row py-3 align-items-center">
                ...
                <div class="col-md-4 text-center">
                    <img src="<?php echo e(asset('theme')); ?>/frontend/img/checklist.jpg" class="w-100 shadow rounded" alt="">
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-8 mx-auto wow fadeInLeft" data-wow-delay="0.2s">
                <div class="h-100">
                    <div class="mb-4 text-center">
                        <h2 class="display-4 mb-0">Project Loan​​​​​​​ FAQ's</h2>
                    </div>
                    <div class="accordion" id="accordionExample">
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingOne">
                                <button class="accordion-button border-0" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                    Q: What is a project loan or construction loan?
                                </button>
                            </h2>
                            <div id="collapseOne" class="accordion-collapse collapse show active" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                <div class="accordion-body rounded">
                                    A: A project loan, also known as a construction loan, is a type of financing provided to individuals or businesses to fund the construction, renovation, or development of a property or infrastructure project.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingTwo">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                    Q: What types of projects are eligible for project loans from Jfinserv?
                                </button>
                            </h2>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingThree">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                    Q: What are the eligibility criteria for availing a project loan from Jfinserv?
                                </button>
                            </h2>
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    A: The eligibility criteria for a project loan may include factors such as the borrower's creditworthiness, project feasibility, repayment capacity, collateral, and compliance with regulatory requirements.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    A: Common documents required for a project loan application may include project plans and estimates, land ownership documents, project feasibility reports, financial statements, etc.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingFive">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                                    Q: What is the maximum loan amount and tenure offered for project loans by Jfinserv?
                                </button>
                            </h2>
                            <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    A: The maximum loan amount and tenure offered for project loans may vary depending on factors such as the nature and scale of the project and the borrower's repayment capacity.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingSix">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                    Q: What is the process for applying for a project loan with Jfinserv?
                                </button>
                            </h2>
                            <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    A: The process for applying for a project loan with Jfinserv involves filling out an application form, submitting the required documents, undergoing project evaluation and appraisal, and loan approval. Our dedicated team of experts will guide you through the process to ensure a smooth experience.
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('frontend.layouts.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u838013575/domains/jfinserv.com/public_html/resources/views/frontend/allLoans/project.blade.php ENDPATH**/ ?>