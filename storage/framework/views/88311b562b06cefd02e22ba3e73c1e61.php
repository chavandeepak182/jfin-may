        ...
        <div class="row g-5 align-items-start mb-5 pb-5">
            ...
            <div class="col-md-9">
                <div class="form-container shadow rounded bg-white p-5">
                    ...
                    <form action="<?php echo e(route('loan.handle_step')); ?>" method="POST" enctype="multipart/form-data" role="form" autocomplete="off" class="form">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="text" name="full_name" value="<?php echo e(old('full_name')); ?>" class="form-control" id="full_name" placeholder="Full Name">
...
<div class="col-md-12">
  <?php if($professional->profession_type!=''): ?>
...
<fieldset>
    ...
    <div class="row g-3">
        ...
        <div class="row mt-2">
            <div class="col-md-6">
                <button type="button" id="check-referral-code" class="btn btn-primary w-100 py-3">Check Code</button>
            </div>
            <div id="referral-feedback" class="col-md-12 mt-3"></div>
        </div>
        <?php endif; ?>
...
document.getElementById('check-referral-code').addEventListener('click', function () {
    ...
    .then(data => {
        if (data.success) {
            ...
            feedbackElement.innerHTML = `<div class="alert alert-danger">Check your referral code</div>`;
    ...
    .catch(error => {
        console.error('Error:', error);
        feedbackElement.innerHTML = '<div class="alert alert-danger">An error occurred while checking the referral code.</div>';
        referralCodeChecked = false; // Mark as not checked
...
<?php echo $__env->make('frontend.layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jfinserv\resources\views/frontend/professional-info.blade.php ENDPATH**/ ?>