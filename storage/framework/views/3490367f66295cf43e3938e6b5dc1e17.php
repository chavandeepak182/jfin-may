                ...
                <div class="row">
                    ...
                    <div class="col-md-8 mx-auto mb-3">
                        <div class="d-flex justify-content-end">
                            <a href="<?php echo e(route('loan.form')); ?>" class="btn btn-primary me-2">Apply New Loan</a>
                            <form method="GET" action="<?php echo e(route('loans.loans-list')); ?>">
                                <select name="status" class="form-control" onchange="this.form.submit()">
                                    ...
                                    <option value="rejected" <?php echo e(request()->status == 'rejected' ? 'selected' : ''); ?>>
                                        Rejected</option>
                                    <option value="disbursed" <?php echo e(request()->status == 'disbursed' ? 'selected' : ''); ?>>
                                        Disbursed</option>
                                    <option value="in process" <?php echo e(request()->status == 'in process' ? 'selected' : ''); ?>>In
                                        Process</option>
                                </select>
                            </form>
                        </div>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $loans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $loan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if(!in_array($loan->status, ['disbursed', 'approved'])): ?>
                                            <a href="loanedit/<?php echo e($loan->loan_id); ?>">Edit</a>
                                        <?php else: ?>
...
<?php echo $__env->make('frontend.layouts.customer-dash', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\jfinserv letest\jfin-may\resources\views/frontend/profile/myloanlist.blade.php ENDPATH**/ ?>