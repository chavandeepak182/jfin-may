...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-6 mb-5 p-5">
            ...
            <a class="btn-search btn btn-danger rounded-1 py-2 px-4 mt-3" href="<?php echo e(route('loan.form')); ?>">APPLY NOW <i class="fa fa-arrow-right"></i></a>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u838013575/domains/jfinserv.com/public_html/resources/views/frontend/firstloan.blade.php ENDPATH**/ ?>