            ...
            <div class="table-responsive">
                <table id="example" class="table table-striped" style="width:100%">
                    ...
                    <?php $__currentLoopData = $data['loans']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                            <tr>
                                ...
                                <td><?php echo e($loan->mobile_no); ?></td>
                                <td><?php echo e($loan->amount); ?></td>                                
                                <td><?php echo e($loan->city); ?></td>
                                <?php if(session()->get('role_id') == 2): ?>
                                    <td>
                                    <a class="btn btn-primary btn-xs view" title="View" href="<?php echo e(route('agent.mis.view', ['id' => $loan->loan_id])); ?>">
                                        <i class="fa fa-eye"></i>
                                    </a>
                                    </td>
                                <?php endif; ?>
...
<?php echo $__env->make('layouts.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u838013575/domains/jfinserv.com/public_html/resources/views/agent/mis.blade.php ENDPATH**/ ?>