             ...
             <li class="nav-item">
                ...
                <div id="collapseLoans" class="collapse" aria-labelledby="headingLoan" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo e(route('approvedLoans')); ?>">Approved Loans</a>
                        <a class="collapse-item" href="<?php echo e(route('disbursed.loans')); ?>">Disbursed Loans</a>
                        <a class="collapse-item" href="<?php echo e(route('rejectedLoans')); ?>">Rejected Loans</a>
                    </div>
                </div>
            </li>
            <?php } ?> 
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseLoans" class="collapse" aria-labelledby="headingLoan" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="<?php echo e(route('agent.inprocess.loans')); ?>">In Process</a>
                            <a class="collapse-item" href="<?php echo e(route('agent.documentpending.loans')); ?>">Document Pending</a>                        
                            <a class="collapse-item" href="<?php echo e(route('agent.approved.loans')); ?>">Approved</a>
                            <a class="collapse-item" href="<?php echo e(route('agent.rejected.loans')); ?>">Rejected</a>
                        </div>
                    </div>
                </li>
            <?php } ?> 
...
<?php /**PATH /home/u838013575/domains/jfinserv.com/public_html/resources/views/layouts/header.blade.php ENDPATH**/ ?>