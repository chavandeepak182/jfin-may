                    ...
                    <div class="row g-4">
                        <div class="col-md-6 col-sm-12">
                            <div class="footer-item">
                                <a href="<?php echo e(url('/')); ?>" class="pb-3">
                                    <!-- <h3 class="text-white"><i class="fab fa-slack me-3"></i> LifeSure</h3> -->
                                    <img src="<?php echo e(asset('theme')); ?>/frontend/img/logo-white.svg" alt="Logo" width="50%">
                                </a>
...
<!-- Copyright End -->
    ...
    <script src="<?php echo e(asset('theme')); ?>/frontend/lib/wow/wow.min.js"></script>
    <script src="<?php echo e(asset('theme')); ?>/frontend/lib/easing/easing.min.js"></script>
    <script src="<?php echo e(asset('theme')); ?>/frontend/lib/waypoints/waypoints.min.js"></script>
    <script src="<?php echo e(asset('theme')); ?>/frontend/lib/counterup/counterup.min.js"></script>
    <script src="<?php echo e(asset('theme')); ?>/frontend/lib/lightbox/js/lightbox.min.js"></script>
    <script src="<?php echo e(asset('theme')); ?>/frontend/lib/owlcarousel/owl.carousel.min.js"></script>    

    <!-- Template Javascript -->
    <script src="<?php echo e(asset('theme')); ?>/frontend/js/main.js"></script>
    ...
    </script><?php /**PATH /home/u838013575/domains/jfinserv.com/public_html/resources/views/frontend/layouts/footer.blade.php ENDPATH**/ ?>