...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card-header py-3">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <!-- Add User Button -->
            <div>
                <a href="<?php echo e(url()->previous()); ?>" class="btn btn-secondary"><i class="bi bi-arrow-left-square me-2"></i>
                    Back</a>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\jfinserv letest\jfin-may\resources\views/admin/edit-loan.blade.php ENDPATH**/ ?>