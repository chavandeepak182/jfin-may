            ...
            <div class="formBx">
                ...
                <form action="<?php echo e(Route('userLogin')); ?>" method="POST" class="row">
                    ...
                    <div class="col-12 mb-3">
                        <label>
                            <input type="radio" name="login_type" value="email" style="width: 5%;" checked> Login with Email & Password
                        </label>
                        <label>
                            <input type="radio" name="login_type" value="mobile" style="width: 5%;"> Login with Mobile & OTP
                        </label>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div id="mobile_login" class="col-12" style="display: none;">
                        <input type="text" name="mobile_no" class="form-control" placeholder="Enter your mobile number" value="<?php echo e(old('mobile_no')); ?>" >
...
unset($__errorArgs, $__bag); ?>
        ...
        <script>
    // Toggle fields based on login type (email or mobile)
    document.querySelectorAll('input[name="login_type"]').forEach((element) => {
        element.addEventListener('change', function() {
            if (this.value === 'email') {
                document.getElementById('email_login').style.display = 'block';
...
<?php /**PATH C:\xampp\htdocs\jfinserv\resources\views/welcome.blade.php ENDPATH**/ ?>