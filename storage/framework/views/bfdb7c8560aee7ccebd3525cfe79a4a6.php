            ...
            <div class="container">
                ...
                <div class="imgBx"><img src="<?php echo e(asset('theme')); ?>/frontend/img/user-login.jpg" alt="" /></div>
                    <div class="formBx">
                         ...
                         <form action="<?php echo e(route('registerUser')); ?>" method="POST" class="row">
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e(old('name')); ?>" placeholder="Enter Your Name" required>
...
unset($__errorArgs, $__bag); ?>" name="mobile_no" value="<?php echo e(old('mobile_no')); ?>" placeholder="Enter Your Phone" required>
...
unset($__errorArgs, $__bag); ?>" name="email_id" value="<?php echo e(old('email_id')); ?>" placeholder="Enter Your Email" required>
...
unset($__errorArgs, $__bag); ?>" id="password" name="password" placeholder="Enter Password" required>
        <div class="pos-ryt">
...
unset($__errorArgs, $__bag); ?>" id="password_confirmation" name="password_confirmation" placeholder="Re-type Password" required>
        <div class="pos-ryt">
...
unset($__errorArgs, $__bag); ?>
    ...
    <p class="signup">Already have an account ? <a href="<?php echo e(route('login')); ?>">Sign in.</a></p>
</form>
                    </div>
                </div>
...
<?php /**PATH /home/u838013575/domains/jfinserv.com/public_html/resources/views/register.blade.php ENDPATH**/ ?>