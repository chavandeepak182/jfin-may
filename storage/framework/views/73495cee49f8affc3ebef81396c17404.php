        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <nav aria-label="breadcrumb" class="d-flex align-items-center">
                <ol class="breadcrumb m-0 bg-transparent">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('loan.profile')); ?>">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="<?php echo e(route('loans.loans-list')); ?>">All Loans</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Edit Loan</li>
                </ol>
            </nav>
            <!-- Add User Button -->
            <div>
                <a href="<?php echo e(route('loans.loans-list')); ?>" class="btn btn-secondary"><i
                        class="bi bi-arrow-left-square me-2"></i> Back</a>
            </div>
        </div>
    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="user_id" name="user_id"
                                            value="<?php echo e($applyingUser->name ?? ''); ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="loan_reference_id"
                                            ...
                                            value="<?php echo e(old('loan_reference_id', $loan->loan_reference_id ?? '')); ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="dob" name="dob"
                                            value="<?php echo e(old('dob', $profile->dob ?? '')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="city" name="city"
                                            value="<?php echo e(old('city', $profile->cityRelation->city ?? '')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="state" name="state"
                                            value="<?php echo e(old('state', $profile->stateRelation->name ?? '')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control" id="status" required
                                            ...
                                            <option value="approved"
                                                <?php echo e(old('status', $loan->status ?? '') == 'approved' ? 'selected' : ''); ?>>
                                                Approved</option>
                                            <option value="rejected"
                                                <?php echo e(old('status', $loan->status ?? '') == 'rejected' ? 'selected' : ''); ?>>
                                                Rejected</option>
                                            <option value="in process"
                                                <?php echo e(old('status', $loan->status ?? '') == 'in process' ? 'selected' : ''); ?>>
                                                In Process</option>
                                            <option value="disbursed"
                                                <?php echo e(old('status', $loan->status ?? '') == 'disbursed' ? 'selected' : ''); ?>>
                                                Disbursed</option>
                                            <option value="document pending"
                                                <?php echo e(old('status', $loan->status ?? '') == 'document pending' ? 'selected' : ''); ?>>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="amount" name="amount"
                                            value="<?php echo e(old('amount', $loan->amount ?? '')); ?>" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="tenure" name="tenure"
                                            value="<?php echo e(old('tenure', $loan->tenure ?? '')); ?>" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="in_principle" id="in_principle" class="form-control">
                                            <option value="Yes" <?php echo e($loan->in_principle == 'Yes' ? 'selected' : ''); ?>>
                                                Yes</option>
                                            <option value="No" <?php echo e($loan->in_principle == 'No' ? 'selected' : ''); ?>>No
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php if($loan->sanction_letter): ?>
                                                    <small>Current file: <a
                                                            href="<?php echo e(asset('storage/sanction_letters/' . $loan->sanction_letter)); ?>"
                                                            target="_blank"><?php echo e($loan->sanction_letter); ?></a></small>
                                                <?php endif; ?>
                                            </div>
                                    </div>
                                </div>
                            ...
                            <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-12 mb-3">
                                    <div class="document-wrapper">
                                        <a href="<?php echo e(Storage::url($doc->file_path)); ?>"
                                            target="_blank"><?php echo e($doc->document_name); ?></a>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="qualification"
                                            name="qualification"
                                            value="<?php echo e(old('qualification', $education->qualification ?? '')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="pass_year" name="pass_year"
                                            value="<?php echo e(old('pass_year', $education->pass_year ?? '')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $('#editLoanForm').submit(function(e) {
                ...
                Swal.fire({
                    title: 'Processing...',
                    html: 'Please wait while we update your loan',
                ...
                $.ajax({
                   url: "<?php echo e(route('updateLoan')); ?>",
                    method: 'POST',
                    ...
                    success: function(response) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                "<?php echo e(route('loans.index')); ?>"; // Redirect to the loans index
                            }
                        });
                    },
...
<?php echo $__env->make('frontend.layouts.customer-dash', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\jfinserv letest\jfin-may\resources\views/frontend/profile/loanedit.blade.php ENDPATH**/ ?>