                ...
                <tbody>
                    <?php $__currentLoopData = $pendingLoans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($loan->category_name ?? 'N/A'); ?></td>
                            <td><?php echo e($loan->amount); ?></td>
                            <td><?php echo e($loan->tenure); ?></td>
                            <td>
                                <form action="<?php echo e(route('assignAgent')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="loan_id" value="<?php echo e($loan->loan_id); ?>">
                                    <div class="form-group">
                                        <label for="agent_id">Assign Agent:</label>
                                        <select name="agent_id" id="agent_id_<?php echo e($loan->loan_id); ?>" class="form-control assign-agent" data-loan-id="<?php echo e($loan->loan_id); ?>">
                                            <option value="">Select Agent</option>
                                            <?php $__currentLoopData = $agents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($agent->id); ?>" <?php echo e($loan->agent_id == $agent->id ? 'selected' : ''); ?>>
...
<script>
    ...
    $('.assign-agent').change(function() {
        ...
        if(agentId) {
            $.ajax({
                url: "<?php echo e(route('assignAgent')); ?>",
                method: "POST",
                data: {
...
<?php echo $__env->make('layouts.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u838013575/domains/jfinserv.com/public_html/resources/views/frontend/pending_loans.blade.php ENDPATH**/ ?>