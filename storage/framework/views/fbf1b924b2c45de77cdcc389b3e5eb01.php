...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="w-100">
                        ...
                        <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="list-group-item">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h6 class="mb-1 text-capitalize"><?php echo e($document->document_name); ?></h6>
                                        <small class="text-muted">Uploaded: <?php echo e(\Carbon\Carbon::parse($document->created_at)->format('d M Y')); ?></small>
                                    </div>
                                    <div class="btn-group">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('loan.update_documents')); ?>" method="POST" enctype="multipart/form-data" id="documents-form">
                    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.customer-dash', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\jfinserv letest\jfin-may\resources\views/frontend/profile/personal-info.blade.php ENDPATH**/ ?>