    ...
    <div class="container-fluid contact bg-light py-5">
        <div class="container mb-5">
            <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                ...
                <a class="btn-search btn btn-dark rounded-0 mt-4 py-3 px-4 px-md-5 me-2 flex-shrink-0" href="<?php echo e(url('/')); ?>">Back to Home</a>
            </div>
        </div>
    </div>               
            
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u838013575/domains/jfinserv.com/public_html/resources/views/frontend/thank-loan.blade.php ENDPATH**/ ?>