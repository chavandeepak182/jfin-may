                ...
                <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
                    <div class="bg-white rounded p-5 h-100">
                        <div class="row g-4 justify-content-center">
                            <div class="col-12">
                                <div class="rounded">
                                    <img src="<?php echo e(asset('theme')); ?>/frontend/img/referral_inner.jpg" class="img-fluid rounded w-100" alt="">
                                </div>
                            </div>
                            <!-- <div class="col-sm-12">
                                    ...
                                    <form action="<?php echo e(route('enquiry.store')); ?>" method="POST">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-lg-12 mb-5">
                                                <div class="form-floating">
                                                    <input type="email" class="form-control border-0" name="email" id="email" value="<?php echo e(old('email')); ?>" placeholder="Your Email" required>
                                            ...
                                            <div class="col-lg-12 col-xl-6">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control border-0" name="referal_code" id="referal_code" value="<?php echo e(old('email')); ?>" placeholder="Your Email" required>
            ...
            <div class="row g-5 align-items-center">
                <div class="col-xl-6 wow fadeInLeft" data-wow-delay="0.2s">
                    ...
                    <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.4s">
                        <img src="<?php echo e(asset('theme')); ?>/frontend/img/carousel-2.png" class="img-fluid w-100" alt="">
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('frontend.layouts.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u838013575/domains/jfinserv.com/public_html/resources/views/frontend/referrals.blade.php ENDPATH**/ ?>