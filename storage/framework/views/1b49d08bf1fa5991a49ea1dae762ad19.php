	...
	<div class="row">
		<div class="col-md-10 mx-auto">
			<div class="row">
                ...
                <div class="col-md-6">
                    <!-- Search Form -->
                    <form method="GET" action="<?php echo e(route('transactions.list')); ?>" class="mb-4">
                        <div class="input-group">
                            <input type="text" name="search" class="form-control" placeholder="Search transactions..." value="<?php echo e(request()->input('search')); ?>">
                ...
                <div class="card-body">
                    <div class="table-responsive" id="transaction_table">
                        <table class="table table-hover my-0 bg-white rounded-0">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <!-- Directly use transactions variable -->
                                <tr>
                                    <td><?php echo e($loop->iteration); ?></td>
                                    <td><?php echo e($transaction->user_name ?? 'No Name'); ?></td>
                                    <td><?php echo e($transaction->transaction_id); ?></td>
                                    <td><?php echo e($transaction->amount); ?></td>
                                    <td><?php echo e($transaction->status); ?></td>
                                    <td><?php echo e(\Carbon\Carbon::parse($transaction->created_at)->format('d M Y, h:i A')); ?></td>
                                    <td>
                                        <button class="btn btn-info show-history-btn" data-transaction-id="<?php echo e($transaction->transaction_id); ?>">
                        ...
                        <div class="d-flex justify-content-center mt-3">
                            <?php echo $transactions->appends(['search' => request()->input('search')])->links('pagination::bootstrap-5'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.customer-dash', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u838013575/domains/jfinserv.com/public_html/resources/views/user/transaction-user.blade.php ENDPATH**/ ?>