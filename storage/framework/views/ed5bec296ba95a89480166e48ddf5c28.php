...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <form method="GET" action="<?php echo e(route('loans.index')); ?>" class="mt-4 mb-3">
                <div class="row justify-content-space-between">
                    <div class="col-md-3">
                        ...
                        <select name="status" id="status" class="form-control">
                            ...
                            <option value="disbursed" <?php echo e(request('status') == 'disbursed' ? 'selected' : ''); ?>>Disbursed
                            </option>
                        </select>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3 d-flex align-items-end">
                        ...
                        <a href="<?php echo e(route('loans.index')); ?>" class="btn btn-secondary ms-2">Reset</a>
                    </div>
                </div>
            </form>
        </div>
            ...
            <div class="table-responsive">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $data['loans']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($loan->user_name ?? 'N/A'); ?></td>
                                <td><?php echo e($loan->loan_category_name ?? 'N/A'); ?></td>
                                <td><?php echo e($loan->amount); ?></td>
                                <td><?php echo e($loan->bank_name ?? 'N/A'); ?></td>
                                <td><?php echo e($loan->city ?? 'N/A'); ?></td>
                                <!-- <td><?php echo e(ucfirst($loan->agent_action) ?? 'Pending'); ?></td> -->
                                <td>
                                    <a class="btn btn-primary btn-xs view" title="View"
                                        href="<?php echo e(route('loan.view', ['id' => $loan->loan_id])); ?>">
                                        <i class="fa fa-eye"></i>
                                    </a>
                                    <a class="btn btn-primary btn-xs edit" title="Edit"
                                        href="<?php echo e(route('editLoan', ['id' => $loan->loan_id])); ?>">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <button class="btn btn-danger btn-xs delete" title="Delete"
                                        onclick="deleteLoan('<?php echo e($loan->loan_id); ?>')">
                ...
                <div class="d-flex justify-content-between align-items-center mt-4">
                    <div class="dataTables_info">
                        Showing <?php echo e($data['loans']->firstItem()); ?> to <?php echo e($data['loans']->lastItem()); ?> of <?php echo e($data['loans']->total()); ?>

                        entries
                    </div>
                    <div class="dataTables_paginate paging_simple_numbers">
                        <nav>
                            <?php echo e($data['loans']->onEachSide(1)->links('pagination::bootstrap-4')); ?>
...
<?php echo $__env->make('layouts.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\jfinserv letest\jfin-may\resources\views/frontend/all-loans.blade.php ENDPATH**/ ?>