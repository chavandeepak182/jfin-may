...
<div class="card-header py-3">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <!-- Add User Button -->
         <div>
            <a href="<?php echo e(route('loans.loans-list')); ?>" class="btn btn-secondary"><i class="bi bi-arrow-left-square me-2"></i> Back</a>
        </div>
    </div>
</div>
...
<?php echo $__env->make('frontend.layouts.customer-dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jfinserv\resources\views/frontend/profile/loanedit.blade.php ENDPATH**/ ?>